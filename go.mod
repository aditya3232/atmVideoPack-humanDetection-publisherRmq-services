module github.com/aditya3232/atmVideoPack-humanDetection-publisherRmq-services.git
...
require (
	...
	github.com/elastic/go-elasticsearch/v7 v7.17.11-0.20230503151926-7c663a64bd40 // indirect
